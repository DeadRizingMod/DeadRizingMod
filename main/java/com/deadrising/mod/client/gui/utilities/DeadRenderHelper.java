...
public class DeadRenderHelper
{
    ...
    public static void renderOtherPlayer(final AbstractClientPlayer givenPlayer, final int x, final int y, final float givenScale, final float givenRotation) {
        GL11.glPushMatrix();
        DeadRenderHelper.PLAYER_RENDERER.renderOtherPlayerModel(givenPlayer, x, y, givenScale, givenRotation);
        GL11.glPopMatrix();
    }
