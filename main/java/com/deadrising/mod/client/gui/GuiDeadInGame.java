...
public class GuiDeadInGame extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButtonDead(1, 42, this.height - 50, 120, 30, I18n.format("menu.returnToMenu", new Object[0])).setImage(new ResourceLocation("deadrising", "textures/gui/menu/play.png")));
        if (!this.mc.isIntegratedServerRunning()) {
            this.buttonList.get(0).displayString = I18n.format("menu.disconnect", new Object[0]);
        }
        this.buttonList.add(new GuiButtonDead(4, 42, this.height - 187, 120, 30, I18n.format("menu.returnToGame", new Object[0])).setImage(new ResourceLocation("deadrising", "textures/gui/menu/play.png")));
